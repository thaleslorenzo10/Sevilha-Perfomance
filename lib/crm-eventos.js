...
async function leadOriginal(email) {
  ...
  try {
    const res = await fetch(
      ...
      `?select=telefone,fbclid,fbp,fbc,external_id,page_url,user_agent,event_id,pagina,utm_campaign,utm_source,utm_content,cargo,escritorio,colaboradores,created_at` +
